...
- Public plugin version / tag: `0.1.1` / `v0.1.1`.
...
- Portal upload ZIP is reconstructed from the public release package (byte-identical to the published plugin ZIP when pins are set); it is not a private overlay.
...
- [ ] The form accepts `submission-out/pr-completion-0.1.1-portal-plugin.zip` on the Skills tab.
