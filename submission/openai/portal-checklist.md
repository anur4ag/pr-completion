...
- Published plugin version / tag: `0.3.0` / `v0.3.0`; the tag, release, checksums, and source pins are public and validated.
...
- [ ] The form accepts `submission-out/pr-completion-0.3.0-portal-plugin.zip` on the Skills tab.
