...
> **Status.** Public dual-harness plugin at [`anur4ag/pr-completion`](https://github.com/anur4ag/pr-completion) (`VERSION` `0.1.2`).
...
# or: codex plugin marketplace add anur4ag/pr-completion --ref v0.1.2
codex plugin add pr-completion@pr-completion
```
